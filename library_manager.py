...
def create_visulations(stats):
    if stats['total books'] > 0:
        ...
        fig_read_status.update_layout(
            title_text="Readn vs Unread Books",
            showlegend=True,
            height=400
        )
...
st.markdown("---")
st.markdown("Copyright @ 2025 Farooq Ahmed Personal Library Manager", unsafe_allow_html=True)
